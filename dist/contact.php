...
<body>
  <div class="wrapper">
    ...
    <main class="main">
      <section class="section full-height-section section-light">
        <div class="container section-container center">
          <h1 class="site-heading">Kontakt</h1>
     ...
     <section class="section">
        <div class="container section-container center">
          ...
          <h1 class="site-heading">Karte</h1>
    ...
    L.marker([52.05963, 10.37428]).addTo(mymap)
        .bindPopup("<b>Ost- und Westsiedlung Salzgitter-Bad Netzwerk n.e.V.</b><br />Weserstrasse 28<br />38259 Salzgitter-Bad").openPopup();
     ...
     <section class="section full-height-section section-light">
        <div class="container section-container center">
          ...
          <p class="lead text-center">
            Schreiben Sie uns eine Nachricht oder kommen Sie vorbei. Eine Wegbeschreibung finden Sie hier.
          </p>
