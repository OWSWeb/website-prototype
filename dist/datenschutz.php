...
<body>
 ...
 <h2>Datenschutzerklärung</h2>
  ...
  <p>
    ...
    Dessen Kontaktdaten können Sie dem <a href="impressum.html">Impressum</a> dieser Website entnehmen.
  </p>
  ...
  <div class="about-owner">
    <ul>
      <li>Sven Moennich</li>
      <li>Weserstrasse 28</li>
      <li>38259 Salzgitter-Bad</li>
    </ul>
    
    <div class="contact">
      <p>Telefon: auf Anfrage</p>
      <p>E-Mail: <a href="mailto:info@ows-sz.de">info@ows-sz.de</a></p>
    </div>
  </div>
  ...
  <h4><em>Widerspruchsrecht gegen die Datenerhebung in besonderen Fällen sowie gegen Direktwerbung (Art. 21 DSGVO)</em></h4>
  ...
  <p><em>
    ...
    werden Ihre personenbezogenen Daten anschließend nicht mehr zum Zwecke der Direktwerbung verwendet
  ...
  <p>
    ...
    in der Datenschutzerklärung von Twitter unter: <a href="https://twitter.com/de/privacy" target="_blank" rel="noopener">https://twitter.com/de/privacy</a>.
  </p>
  ...
  <p>
    ...
    <a href="https://twitter.com/account/settings" target="_blank" rel="noopener">https://twitter.com/account/settings</a> ändern.
  </p>
  ...
  <p>
    Diese Website benutzt den Open Source Webanalysedienst Matomo. Matomo verwendet sogenannte
  ...
  <p>
    Die Speicherung von Matomo-Cookies und die Nutzung dieses Analyse-Tools erfolgen auf Grundlage
    von Art. 6 Abs. 1 lit. f DSGVO. Der Websitebetreiber hat ein berechtigtes Interesse
    an der anonymisierten Analyse des Nutzerverhaltens, um sowohl sein Webangebot als auch seine Werbung zu optimieren.
  </p>
  ...
  <p>
    ...
    bevor diese sich das Video ansehen. Die Weitergabe von Daten an YouTube-Partner wird durch den
  ...
  <p>
    Sobald Sie ein YouTube-Video auf unserer Website starten, wird eine Verbindung zu den Servern von YouTube hergestellt.
  ...
  <p>
    ...
    Mit Hilfe dieser Cookies kann YouTube Informationen über Besucher unserer Website erhalten.
    Diese Informationen werden u.a. verwendet, um Videostatistiken zu erfassen, die Anwenderfreundlichkeit
    zu verbessern und Betrugsversuchen vorzubeugen. Die Cookies verbleiben auf Ihrem Endgerät, bis Sie sie löschen.
  </p>
  ...
  <p>
    ...
    <a href="https://www.youtube.com/t/privacy_at_youtube" target="_blank" rel="noopener">https://www.youtube.com/t/privacy_at_youtube</a>.
  </p>
  ...
  <p>
    Die Seite nutzt zur optimalen Darstellung und schnellen Bereitstellung von Bildern, Videos und sonstigen Mediendateien
    den Dienst "Cloudinary" der Cloudinary Ltd., 3 Waterhouse Square, 138 Holborn EC1N 2SW, London, UK.
  </p>

  <p>
    Beim Aufruf einer Seite lädt Ihr Browser die benötigten Mediendateien in Ihren Browsercache, um Mediendateien korrekt anzuzeigen
    und multimediale Inhalte ohne große Performanceverluste auf unserer Seite einzusetzen.
  </p>

  <p>
    Zu diesem Zweck muss der von Ihnen verwendete Browser Verbindung zu den Servern von Cloudinary
    aufnehmen. Hierdurch erlangt Cloudinary Kenntnis darüber, dass über Ihre IP-Adresse unsere Website
    aufgerufen wurde. Die Nutzung von Cloudinary erfolgt im Interesse einer multimedialen, performanten und
    ansprechenden Darstellung unserer Online-Angebote. Dies stellt ein berechtigtes Interesse im Sinne von
    Art. 6 Abs. 1 lit. f DSGVO dar.
  </p>

  <p>
    Weitere Informationen zu Cloudinary finden Sie unter
    <a href="https://cloudinary.com/faq" target="_blank" rel="noopener">https://cloudinary.com/faq</a>
    und in der Datenschutzerklärung von Cloudinary:
    <a href="https://cloudinary.com/privacy" target="_blank" rel="noopener">https://cloudinary.com/privacy</a>.
  </p>

  <h4>CodePen</h4>

  <p>
    Die Seite nutzt zur optimalen und ansprechenden Darstellung von Code-Schnipseln und einer dazugehörigen Vorschau
    ein Plugin von der Website CodePen. Betreiber der Seiten ist die CodePen Inc., 919 NW Bond St. Suite 203, Bend OR 97702, USA.
  </p>

  <p>
    Sobald Sie eine unserer Seiten mit dem CodePen Plugin aufrufen, lädt Ihr Browser die benötigten Scripte und Daten,
    um das Widget darzustellen.
  </p>

  <p>
    Zu diesem Zweck muss der von Ihnen verwendete Browser Verbindung zu den Servern von CodePen aufnehmen.
    Hierdurch erlangt CodePen Kenntnis darüber, dass über Ihre IP-Adresse unsere Website aufgerufen wurde.
    Nach den eigenen Angaben des Unternehmens werden dabei allerdings keinerlei personenbezogene Daten
    verarbeitet bzw. gespeichert. Die Nutzung von CodePen erfolgt im Interesse einer ansprechenden Präsentation
    von Code-Schnipseln, die zuvor bei CodePen hochgeladen wurden. Solche bei CodePen veröffentlichte Code-Schnipsel,
    auch "Pen" genannt, ermöglichen Ihnen zudem eine einfache Weiterverwendung des Quellcodes für Ihre eigenen Zwecke.
    Die Nutzung des CodePen Plugins stellt ein berechtigtes Interesse im Sinne von Art. 6 Abs. 1 lit. f DSGVO dar.
  </p>

  <h4>GitHub</h4>

  <p>
    Die Seite nutzt zur optimalen und ansprechenden Darstellung von Code-Schnipseln
    ein Plugin von der Website GitHub. Betreiber der Seiten ist die GitHub Inc., 88 Colin P Kelly Jr St, San Francisco, CA 94107, USA.
  </p>

  <p>
    Sobald Sie eine unserer Seiten mit dem GitHub Plugin aufrufen, lädt Ihr Browser die benötigten Scripte und Daten,
    um das Widget darzustellen.
  </p>

  <p>
    Zu diesem Zweck muss der von Ihnen verwendete Browser Verbindung zu den Servern von GitHub aufnehmen.
    Hierdurch erlangt GitHub Kenntnis darüber, dass über Ihre IP-Adresse unsere Website aufgerufen wurde.
    Die Nutzung von GitHub erfolgt im Interesse einer ansprechenden Präsentation von Code-Schnipseln,
    die zuvor bei GitHub hochgeladen wurden. Solche bei GitHub veröffentlichte Code-Schnipsel, auch "Gist" genannt,
    ermöglichen Ihnen zudem eine einfache Weiterverwendung des Quellcodes für Ihre eigenen Zwecke.
    Die Nutzung des GitHub Plugins stellt ein berechtigtes Interesse im Sinne von Art. 6 Abs. 1 lit. f DSGVO dar.
  </p>

  <p><small class="source">Quelle: <a href="https://www.e-recht24.de/" target="_blank" rel="noopener">eRecht24</a> (vom Betreiber bearbeitet bzw. ergänzt)</small></p>
