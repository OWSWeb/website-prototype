    ...
    <main class="main">
      <section class="section full-height-section section-light">
        <div class="container section-container center">
          <h1 class="site-heading">Bestaetigungs Link</h1>

          <p class="text-center w-800">
            Sie erhalten in kuerze eine E-Mail mit einem Bestaetigungslink.
            Bitte rufen sie diesen Link auf und klicken dann auf Weiter.
          </p>

            <button type="submit" onclick="location.href='sign-in.php';" class="btn btn-primary">Weiter</button>
